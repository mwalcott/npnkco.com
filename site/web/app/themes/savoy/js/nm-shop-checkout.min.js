...
a.addClass("active");c.children(".payment_box").hide();a.children(".payment_box").show()})},loginCouponShowForm:function(c,a){b.magnificPopup.open({mainClass:a+" nm-mfp-fade-in",alignTop:!0,closeMarkup:'<a class="mfp-close nm-font nm-font-close2"></a>',removalDelay:180,items:{src:c,type:"inline"}})}});b.nmThemeExtensions.checkout=b.nmTheme.checkout_init})(jQuery);